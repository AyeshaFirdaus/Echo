package com.example.ayesha.echo.activities
...
import com.example.ayesha.echo.MainScreenFragment
import com.example.ayesha.echo.R
import com.example.ayesha.echo.adapters.NavigationDrawerAdapter
...
class MainActivity : AppCompatActivity()     {
    ...
    override fun onCreate(savedInstanceState: Bundle?, persistentState: PersistableBundle?) {
        ...
        MainActivity.Satisfied.drawerLayout = findViewById(R.id.drawer_layout)
        ...
        val toggle=ActionBarDrawerToggle(this@MainActivity,MainActivity.Satisfied.drawerLayout,toolbar, R.string.navigation_drawer_open, R.string.navigation_drawer_close)

        MainActivity.Satisfied.drawerLayout?.setDrawerListener(toggle)
        toggle.syncState()
